  ...
  <div>
    ...
    <div>
      ...
      <div v-else>
        ...
        <div>
          <div
            class="card"
            style="width: 19rem; float: left; border-radius: 20px; margin: 10px"
          >
            <img
          ...
          <div
            class="card"
            style="width: 20rem; float: left; border-radius: 20px; margin: 10px"
          >
            <img
              class="card-img-top card-image"
              src="../assets/kyc2.png"
          ...
          >
            ...
            <div class="card-body" style="color: #8080808a">
              ...
              <hf-buttons
                ...
                style="text-align: right"
                class="ml-auto mt-4"
                @executeAction="openSlider('EDV_API')"
                disabled
              >
              </hf-buttons>
            </div>
      ...
      <div class="border p-2">
        <div class="form-group">
          ...
          <input
            ...
            class="form-control"
            id="orgDid"
            placeholder="hypersign.id"
            v-model="domainFromOriginComputed"
        ...
        <div
          class="form-group"
          v-if="appModel.domain && appModel.dependentServices"
        >
        ...
        <div class="form-group" v-if="appModel.domain">
          ...
          <label for="selectService"
            ><strong
              >Select Issuer DID<span style="color: red">*</span>:
            </strong></label
          >
          <select
            class="custom-select"
            id="selectService"
            v-model="appModel.issuerDid"
            v-if="!appModel.issuerDid"
          >
            ...
            <div class="input-group-append">
              <span class="input-group-text" id="basic-addon2">
                <i
                  ...
                  @click="copyToClip(txtRecord, 'TXT Record')"
                >
                </i>
              </span>
            </div>
    ...
    <StudioSideBar :title="edit ? 'Edit Service' : 'Add Service'">
      <div class="container">
          ...
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <span class="input-group-text" id="basic-addon2">
                <i
                  class="far fa-copy mt-1"
                  @click="copyToClip(appModel.appId, 'Service Id')"
                >
                </i>
              </span>
            </div>
        ...
        <div class="form-group">
          ...
          <label for="domain"
            ><strong
              >Domain (Origin)<span style="color: red">*</span>:
            </strong></label
          >
          <div class="input-group mb-1">
            <input
              ...
              v-model="appModel.domain"
              aria-describedby="orgDomain"
              :disabled="
                appModel.hasDomainVerified &&
        ...
        <div class="form-group" v-if="edit === true">
          ...
          <small
            ><a :href="`${swaggerAPIdoc}`" target="_blank"
        ...
        >
          ...
          <small
            ><a
              :href="`${$config.explorer.BASE_URL}/account/${appModel.walletAddress}`"
              target="_blank"
        ...
        <div class="form-group" v-if="edit === false">
          <tool-tip
            infoMessage="Select a service you want to associate with this app"
          ></tool-tip>
          <label for="selectService"
            ><strong
          ...
          >
            <option
              ...
              v-for="eachService in selectServicesOptions"
              v-bind:key="eachService.id"
            >
              {{ eachService.name }}
            </option>
          </select>
        ...
        >
          ...
          <label for="selectService"
            ><strong
              >Associate SSI Service<span style="color: red">*</span>:
            </strong></label
          >
          <select
            class="custom-select"
            id="selectSSIService"
            v-model="selectedAssociatedSSIAppId"
            @change="onSSIServiceChange($event)"
          >
            <option value="" disabled>Select a service</option>
            <option
              :value="eachSSIApp.appId"
              v-for="eachSSIApp in getAppsWithSSIServices"
        ...
        <div class="form-group" v-if="edit === true">
          ...
          <label for="selectService"
            ><strong
              >Select Environment<span style="color: red">*</span>:
            </strong></label
          >
          <select
            class="custom-select"
    ...
    <div v-if="appList.length > 0" class="mt-2">
      <b-tabs content-class="mt-0">
        <b-tab
          :title="'SSI (' + getAppsWithSSIServices.length + ')'"
          active
          v-if="getAppsWithSSIServices.length > 0"
          class="bg-white p-3"
        >
          <div class="row">
            <div
              class="col-md-4 mb-4"
              v-for="eachOrg in getAppsWithSSIServices"
              :key="eachOrg.appId"
            >
              <div
                class="card"
                @click="switchOrg(eachOrg.appId, 'SSI_API')"
                style="cursor: grab"
              >
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col">
                      <b-card-text>
                        ...
                        <div
                          class="apiKeySecret"
                          @click.stop="copyToClip(eachOrg.appId, 'Service Id')"
                    ...
                    <div class="col">
                      <span class=" " style="float: right">
                        ...
                        <span
                          ...
                          @click.stop="editOrg(eachOrg.appId)"
        ...
        <b-tab
          :title="'KYC (' + getAppsWithKYCServices.length + ')'"
          v-if="getAppsWithKYCServices.length > 0"
          class="bg-white p-3"
        >
          <div class="row">
            <div
              class="col-md-4 mb-4"
              v-for="eachOrg in getAppsWithKYCServices"
              :key="eachOrg.appId"
            >
              <div
                class="card"
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            >
                              {{ formattedAppName(eachOrg.appName) }}
                              <img
                                src="../assets/verified-success.png"
                      ...
                      <div class="col">
                        ...
                        <span style="float: left">
                          <span
                            ...
                            v-if="eachOrg.env == 'dev'"
                            >{{ eachOrg.env }}</span
                          >
                          <span
                            class="badge bg-success text-white mx-1"
                            v-else
                            >{{ eachOrg.env }}</span
                          >

                          <span
                            class="badge rounded bg-light mx-1"
                            v-if="eachOrg.domain && eachOrg.hasDomainVerified"
                          >
                            <a
                              @click.stop
                              :href="eachOrg.domain"
                        ...
                        <span class=" " style="float: right">
                          <span
                            ...
                            @click.stop="verifyDomainOpenPopup(eachOrg)"
                            title="Click to verify your domain"
                            v-if="
