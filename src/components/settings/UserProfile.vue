      ...
      <div class="confirm-body">
        <template v-if="removeAuthStep === 'confirm'">
          ...
          <div class="confirm-actions">
            ...
            <hf-buttons name="Proceed" customClass="btn btn-danger ml-2" @executeAction="showRemoveAuthCodeStep" />
          </div>
        </template>
        ...
        <template v-else>
          ...
          <div class="confirm-actions">
            <hf-buttons name="Back" customClass="btn btn-outline-secondary" @executeAction="showRemoveAuthConfirmStep" />
